        ...
        {studentInfo && (
          <div className="mt-2 bg-blue-50 p-4 rounded-lg">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
              ...
              <div>
                <span className="font-semibold">Roll No:</span> {studentInfo.roll_number}
              </div>
              <div>
                <span className="font-semibold">Department:</span> {studentInfo.department}
              </div>
              <div>
                <span className="font-semibold">Semester:</span> {studentInfo.semester}
              </div>
            </div>
          </div>
        )}
            ...
            {stats.subject_stats.map((subject, index) => (
              <div key={index} className="border border-gray-200 rounded-lg p-4">
                ...
                <div className="flex items-center justify-between text-sm text-gray-600">
                  <span>Classes attended: {subject.present_classes} / {subject.total_classes}</span>
